...
More information about the package datasets available [here](https://covid19r.github.io/covid19italy/articles/intro.html)
...
While the **covid19italy** [CRAN version](https://cloud.r-project.org/web/packages/covid19italy/index.html) is updated every month or two, the [Github (Dev) version](https://github.com/Covid19R/covid19italy) is updated on a daily bases. The `update_data` function enables to overcome this gap and keep the installed version with the most recent data available on the Github version:
