...
![Data refresh](https://github.com/RamiKrispin/covid19Italy/workflows/Data%20Refresh/badge.svg)
<!-- badges: end -->
...
orca(p, "man/figures/positive_dist.png")
```
...
orca(p, "man/figures/case_dist.png")
```
...
orca(p, "man/figures/region_bar_plot.png")
```
...
orca(p, "man/figures/province_pie.png")
```
